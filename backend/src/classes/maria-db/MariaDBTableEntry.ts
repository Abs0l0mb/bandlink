...
export class MariaDBTableEntry {
    ...
    */
    public async load() : Promise<boolean> {
        ...
        const result = await MariaDB.getRows(query, binder.getParams());
    ...
    */
    public async update(data: any) : Promise<boolean>{
        ...
        await MariaDB.exec(query, binder.getParams());
    ...
    */
    public async delete() : Promise<void> {
        ...
        return MariaDB.exec(query, binder.getParams());
    }
}